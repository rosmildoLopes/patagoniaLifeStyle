...
const Beneficios = () => {
  return (
    <div className="flex flex-wrap gap-4 w-9/12 md:w-full mx-auto md:py-12 justify-center items-center">
      {beneficiosData.map((beneficio, index) => (
        ...
        >
          ...
          <div className="flex flex-col justify-start md:gap-6">
            ...
            <p className="text-start text-sm md:text-base text-black">
              {beneficio.content}
            </p>
          </div>
        </motion.div>
