export const DrawOutlineButton = ({ children, className = "", ...rest }) => {
  return (
    <button
      {...rest}
      className={`group relative py-3 px-5 border-2 border-text transition-colors duration-[400ms] ${className}`}
    >
      <span>{children}</span>
